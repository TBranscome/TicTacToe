...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        audio('./media/beep.mp3');
        //this conditon checks to see if it is computers turn
        if(activePlayer === 'O'){
            //this function disables clicking for computer choice
            disableClick();
            //this function waits 1 second before placing the image and enable click
            setTimeout(function (){ computersTurn(); }, 1000);
        }
        //returning true is needed for our computersTun() function to work
        return true;
    }
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
            ...
            c.moveTo(x1, y1);
            //this method indicates the end poit for our line
            c.lineTo(x, y);
